-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('ALL', 'EARNED', 'SPENT');
...
-- CreateIndex
CREATE INDEX "recent_activities_userId_createdAt_idx" ON "recent_activities"("userId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "user_question_attempts" ADD CONSTRAINT "user_question_attempts_quizId_fkey" FOREIGN KEY ("quizId") REFERENCES "quizzes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "coins_transactions" ADD CONSTRAINT "coins_transactions_userProfileId_fkey" FOREIGN KEY ("userProfileId") REFERENCES "users_profile"("user_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "users_badges" ADD CONSTRAINT "users_badges_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "themes" ADD CONSTRAINT "themes_userProfileId_fkey" FOREIGN KEY ("userProfileId") REFERENCES "users_profile"("user_id") ON DELETE CASCADE ON UPDATE CASCADE;
