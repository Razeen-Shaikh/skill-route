...
-- CreateEnum
CREATE TYPE "RoadmapType" AS ENUM ('AI', 'BACKEND', 'DEVOPS', 'FRONTEND', 'FULLSTACK', 'DATA_SCIENCE', 'MOBILE', 'MACHINE_LEARNING', 'MERN', 'MEAN', 'BLOCKCHAIN', 'CYBER_SECURITY', 'GAMING', 'CLOUD', 'SOFTWARE_TESTING');
...
-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('EARNED', 'PENALTY', 'REWARD', 'SPENT', 'ALL');
...
CREATE TABLE "users_profile" (
    ...
    "completedRoadmaps" TEXT[],
    "completedSteps" TEXT[],
    "completedChallenges" TEXT[],
    "completedInterviews" TEXT[],
...
CREATE TABLE "users_streaks" (
    ...
    "longestStart" TIMESTAMP(3),
    "longestEnd" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "badges" (
    ...
    "xpReq" INTEGER NOT NULL DEFAULT 0,
    "description" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "coin_wallet" (
    ...
    CONSTRAINT "coin_wallet_pkey" PRIMARY KEY ("user_id")
);
